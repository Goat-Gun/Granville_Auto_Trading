def errors(err_code):
    err_dic = {0:('OP_ERR_NONE','정상처리'),
                ...
                -106:('OP_ERR_SOCKED_CLOSED','통신연결종료'),
                ...
                -301:('OP_ERR_ORD_WRONG_ACCTND','계좌비밀번호없음'),
                -302:('OP_ERR_OTHER_ACC_USE','타인계좌사용오류'),
                -303:('OP_ERR_MIS_2BILL_EXC','주문가격이20억초과'),
                ...
                -309:('OP_ERR_3OOCNT_EXC','주문수량300계약초과'),
                -310:('OP_ERR_5OOCNT_EXC','주문수량500계약초과'),
